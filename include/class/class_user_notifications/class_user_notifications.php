...
function user_account_activation(){
    ...
    $strSubject="Activate your " . WEB_NAME . " account";
	$headers  = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
    'X-Mailer: PHP/' . phpversion(). "\r\n";
    $headers .= "From: " . WEB_NAME . " <".$strFrom.">"."\r\n";
    ...
    $strMailbody.= "Dear ".$name.",<br /><br />";
    $strMailbody .="Thank you  for registering with us at " . WEB_NAME . ". We look forward to seeing you around in the site.<br />";
$strMailbody.="To complete your registration, you need to confirm that you received this email.<br/>";
    ...
    $strMailbody .="<br />Here are your login details for http://" . WEB_NAME . " site .<br/>You can change your password after you log into the site.<br /><br />";
   
    
    $strMailbody .="Your Username :". $this->username ."<br />";
    $strMailbody .="Your Password :". $this->password . "<br /><br /><br /><br /><br />
    Thanks,<br />" . WEB_NAME . " Team<br/>";
    $strMailbody .="If clicking the link does not work, just copy and paste the entire link into your browser. If you are still having problems, simply forward this email to ". EMAIL_SUPPORT . " and we will do our best to help you. <br/>";
 $strMailbody=$this->get_email_template($strMailbody); 
...
function user_welcome_email(){
   ...
   $strFrom=EMAIL_NO_REPLY;
    ...
    $strSubject="Welcome to " . WEB_NAME . "";
	$headers  = 'MIME-Version: 1.0' . "\r\n";
    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
    'X-Mailer: PHP/' . phpversion(). "\r\n";
    $headers .= "From: " . WEB_NAME . " <".$strFrom.">"."\r\n";
...
$headers .= "X-Priority: 1 (Highest)\n";
	...
	$name=$this->username;	
		...
		$strMailbody .=	"<br />Team ".WEB_NAME."<br /><br />";
		$strMailbody=$this->get_email_template($strMailbody);
        	mail($strTo,$strSubject,$strMailbody,$headers);
	return true;
        }
