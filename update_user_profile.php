...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->access_list = array("REGISTERED_USER_UNVERIFIED");
	...
	$page->class_list = array("class_user.php","class_pagination.php","class_exam.php");
	...
	$page->module		= 'imported_user_profile';
